...
export const STOREFRONT_COPY = {
  ...
  pricingSignIn:
    'Prices and lot availability are shown to research accounts. It takes a minute: your email, one confirmation click, and the research-use acknowledgement. Organizations that need purchase orders or net terms apply for a wholesale account on the same form.',
