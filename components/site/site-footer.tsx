      ...
      <div className="mx-auto max-w-[1500px] px-5 py-14 sm:px-8 lg:px-12">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.4fr_repeat(4,1fr)]">
          <div className="max-w-sm">
            ...
            <p className="mt-5 text-sm leading-6 text-muted-foreground">
              An independent supplier of research materials for qualified laboratory organizations in the United
              States. Every lot ships with its own analytical documentation.
            </p>
          </div>

          {columns.map((column) => (
            <div key={column.heading}>
              <p className="utility-label text-muted-foreground">{column.heading}</p>
        ...
        <div className="mt-12 border-t border-border pt-8">
          <p className="max-w-4xl text-xs leading-6 text-muted-foreground">
            <strong className="font-semibold text-foreground">Research use only.</strong> All materials listed on
            this site are supplied strictly for in vitro laboratory research and analytical use by qualified
            organizations. They are not drugs, medicines, dietary supplements, cosmetics, food, or consumer
            products. They are not for human or veterinary use, not for clinical or diagnostic procedures, and not
            for consumption. Nothing on this site is medical advice, and no statement here has been evaluated by
            the Food and Drug Administration. Purchasers are solely responsible for compliance with all applicable
