...
export function HeaderSearch() {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <form action="/catalog" method="get" role="search" className="absolute right-0 top-[calc(100%+0.75rem)] flex w-[min(32rem,calc(100vw-2rem))] gap-2 rounded-[1.25rem] border border-border bg-white p-3 shadow-[0_24px_60px_rgba(14,18,59,0.2)]">
