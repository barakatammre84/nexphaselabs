  ...
  return (
    ...
    >
      ...
      <LegalSection heading="4. Carriers, cost and tracking">
        <p>
          Shipments travel by UPS, FedEx or USPS with tracking. Shipping options and their cost are shown at
          checkout before you pay, and depend on the service, the destination and whether cold packaging is needed.
          We may choose a different carrier than the one shown if it gets the material there in better condition, at
