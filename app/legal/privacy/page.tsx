  ...
  return (
    ...
    >
      ...
      <LegalSection heading="2. What we collect">
        ...
        <p>
          When you create an account: your name, email address, a password we store only as a one-way hash, any
          research setting you select, and the time and version of each confirmation you give — the age statement,
          the research-use acknowledgement and the terms of sale. Researchers self-declare that they are at least{' '}
          {MINIMUM_AGE}; we do not ask them for a date of birth. Institutional accounts provide a date of birth so we
          can check the minimum age. We also retain and check a date of birth if a researcher supplies one through a
          legacy form. A date of birth is never shown.
          {turnstileEnabled()
