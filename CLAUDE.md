...
Operating entity: 8486 Ventures LLC (California), doing business as Nexphaselabs (the brand is written
NexPhase Labs on the site). Zelle payments go to the legal name, 8486 Ventures LLC, not the DBA.
