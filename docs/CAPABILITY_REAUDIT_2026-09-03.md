...
- Final long-history release: commit 1cc04fb, staging version e7630c44-ce11-46bd-874d-a03362f0c2a4. Release 303 tests and shared-project 328 tests passed again, together with typecheck/lint and staging build. Live health returned db=ok/docs=ok, robots disallowed indexing, unauthenticated order export returned 401 and an unknown lot returned 404. No migration or live-provider activation.
